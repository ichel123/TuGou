				...
				<li id="slide-<?php the_ID(); ?>" class="zeeslide">
					...
					if ( has_post_thumbnail() ) : ?>
						...
						<div class="slide-image">
							<?php the_post_thumbnail( 'leeway-slider-image', array( 'loading' => false ) ); ?>
						</div>

					<?php else: ?>

						<div class="slide-image">
							<img src="<?php echo esc_url( get_template_directory_uri() . '/images/default-slider-image.png' ); ?>" class="wp-post-image" alt="default-image" />
						</div>
